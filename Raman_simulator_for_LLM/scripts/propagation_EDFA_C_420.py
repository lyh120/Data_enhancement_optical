...
def gn_occ_new(loading_status, gain_list, tilt_list, bool_verbose=True):
    ...
    voa = VOA(db2lin(0.1))
    voa_28db = VOA(db2lin(2.8))
    voa_31db = VOA(db2lin(3.1))
    ...
    sig_arr, ase_arr, nli_arr = voa_28db(sig_arr, ase_arr, nli_arr)
    ...
    sig_arr, ase_arr, nli_arr = voa_28db(sig_arr, ase_arr, nli_arr)
    sig_arr, ase_arr, nli_arr = voa(sig_arr, ase_arr, nli_arr)
    sig_arr, ase_arr, nli_arr = propagation(power_list, freq_list, direction_list,sig_arr, ase_arr=ase_arr, nli_arr=nli_arr,
    ...
    sig_arr, ase_arr, nli_arr = voa_31db(sig_arr, ase_arr, nli_arr)
    sig_arr, ase_arr, nli_arr = propagation(power_list, freq_list, direction_list,sig_arr, ase_arr=ase_arr, nli_arr=nli_arr,
    ...
    rho1 = np.array([1.3, 1.25 ,1.25, 1.25, 1.05, 1.1])
    rho2 = np.array([16.21, 14.42, 14.45, 14.52, 14.94, 14.84])
